...
inline void photoexcitation_lorentz(py::module_& m) {
  m.doc() =
    "Photoexcitation transitions rates using Lorentz line\n"
    "shape.\n"
  ;

  m.def(
    "R_ij",
    &astrea::transition::photoexcitation_lorentz::R_ij,
  ...
  m.def(
    "R_KK",
    &astrea::transition::photoexcitation_lorentz::R_KK,
  ...
  m.def(
    "R_ZKK",
    &astrea::transition::photoexcitation_lorentz::R_ZKK,
    "Photoexcitation transition rates using Lorentz line shape.\n"
    "\n"
  ...
  m.def(
    "R_XZKK",
    &astrea::transition::photoexcitation_lorentz::R_XZKK,
    "Photoexcitation transition rates using Lorentz line shape.\n"
    "\n"
