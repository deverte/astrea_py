...
inline void collisional_excitation(py::module_& m) {
  m.doc() =
  ...
  m.def(
    "R_ij",
    &astrea::transition::collisional_excitation::R_ij,
  ...
  m.def(
    "R_KK",
    &astrea::transition::collisional_excitation::R_KK,
    "Collisional excitation transitions rate.\n"
    "\n"
    ":param T: Temperature in K.\n"
    ":param N_e: Electron number density in cm-3.\n"
  ...
  m.def(
    "R_ZKK",
    &astrea::transition::collisional_excitation::R_ZKK,
    "Collisional excitation transitions rate.\n"
    "\n"
    ":param T: Temperature in K.\n"
    ":param N_e: Electron number density in cm-3.\n"
  ...
  m.def(
    "R_XZKK",
    &astrea::transition::collisional_excitation::R_XZKK,
