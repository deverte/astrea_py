...
inline void hd_209458_fossati(py::module_& m) {
  m.doc() =
    "HD 209458 XUV 9 spectrum by Fossati+2020.\n"
  ...
  m.def(
    ...
    &astrea::spectrum::hd_209458_fossati::E_q_lambda_vs_lambda,
    "HD 209458 XUV 9 spectrum by Fossati+2020.\n"
    "\n"
  ...
  m.def(
    "F_lambda_vs_lambda",
    &astrea::spectrum::hd_209458_fossati::F_lambda_vs_lambda,
    "HD 209458 XUV 9 spectrum by Fossati+2020.\n"
    "\n"
    "- Axis 0: Bivariate data (row).\n"
    "  - 0: Wavelength in nm.\n"
