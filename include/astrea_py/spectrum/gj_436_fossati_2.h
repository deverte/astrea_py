...
inline void gj_436_fossati_2(py::module_& m) {
  m.doc() =
    "GJ 436 XUV spectrum by Fossati (private communication).\n"
    "Total energy at <912 A is 0.86 erg/cm^2/s at R=1 a.u.\n"
    "Total energy at 1000-3000 A is 2.72 erg/cm^2/s at R=1 a.u.\n"
    "Hydrogen ionization rate at GJ436b orbit 9.5e-6 s^-1 (29.2 hours)"
  ;

  m.def(
    "E_q_lambda_vs_lambda",
    &astrea::spectrum::gj_436_fossati_2::E_q_lambda_vs_lambda,
    "GJ 436 XUV spectrum by Fossati (private communication).\n"
    "\n"
  ...
  m.def(
    "F_lambda_vs_lambda",
    &astrea::spectrum::gj_436_fossati_2::F_lambda_vs_lambda,
    "GJ 436 XUV spectrum by Fossati (private communication).\n"
    "\n"
    "- Axis 0: Bivariate data (row).\n"
    "  - 0: Wavelength in nm.\n"
